...
class Transformer_TextCNN_modify(BasicModule):
    def __init__(self, args, vectors=None):
        super(Transformer_TextCNN_modify, self).__init__()
        ...
        self.name_fc = nn.Sequential(
            nn.Linear(5 * args.kernel_num, args.linear_hidden_size),
        ...
        self.fc1 = nn.Linear(args.label_size * 2, args.label_size)
