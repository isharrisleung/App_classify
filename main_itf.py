...
def main(**kwargs):
    ...
    with open("./name_pickle", "rb") as f:
        name_embd = pickle.load(f)
    with open("./desc_pkl", "rb") as f:
        desc_embd = pickle.load(f)
    criterion = nn.CrossEntropyLoss()
    train_data = pd.read_csv(args.data_path)
    test_data = pd.read_csv(args.test_path)
    test_dataset = data.TfidTestAppDataset(name_embd, desc_embd, test_data, args, "WordVec")
    ...
    for k, (train_idx, val_idx) in enumerate(kf.split(train_data)):
        ...
        train_dataset = data.TfidAppDataset(name_embd, desc_embd, train, args, "WordVec")
        val_dataset = data.TfidAppDataset(name_embd, desc_embd, val, args, "WordVec")
